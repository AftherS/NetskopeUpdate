<#
.SYNOPSIS
	This script performs the uninstallation of 7-Zip.
	# LICENSE #
...
.EXAMPLE
    PowerShell.exe .\Uninstall-7zip.ps1 -DeploymentType "Uninstall" -DeployMode "NonInteractive"
.EXAMPLE
    PowerShell.exe .\Uninstall-7zip.ps1 -DeploymentType "Uninstall" -DeployMode "Silent"
.EXAMPLE
    PowerShell.exe .\Uninstall-7zip.ps1 -DeploymentType "Uninstall" -DeployMode "Interactive"
.NOTES
...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = '7-Zip Uninstall'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = ''
	[string]$appRevision = ''
	...
	[string]$installName = ''
	[string]$installTitle = 'Igor Pavlov 7-Zip Uninstall'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        Show-InstallationProgress -StatusMessage "Uninstalling Any Existing Versions of 7-Zip. Please Wait..."
